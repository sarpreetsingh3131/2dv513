...
export let GET_BOATS = 'SELECT boat.id, year, length, member.name AS owner, boat_type.type FROM boat_club.boat JOIN member ON boat.member_id = member_id JOIN boat_type ON boat.type_id = boat_type.id'
